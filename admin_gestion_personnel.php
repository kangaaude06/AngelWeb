...
<head>
    ...
    <style>
        ...
        .container { padding: 20px; max-width: 600px; margin: 20px auto; border: 1px solid var(--violet); border-radius: 8px; background-color: var(--texte-clair); box-shadow: 2px 2px 10px rgba(138, 43, 226, 0.1); }
        .form-group { margin-bottom: 15px; }
        .form-group label { display: block; font-weight: bold; margin-bottom: 5px; }
        .form-group input, .form-group select { width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; }
        button { background-color: var(--violet); color: var(--blanc); padding: 10px 15px; border: none; border-radius: 5px; cursor: pointer; font-size: 1em; font-weight: bold; }
        ...
        .back-link a { color: var(--violet); font-weight: bold; }
    </style>
</head>
<body>
    <header>
    ...
    <div class="container">
        ...
        <p class="back-link" style="margin-top: 20px;"><a href="dashboard_admin.php">← Retour au Tableau de Bord</a></p>
    </div>
</body>
</html>